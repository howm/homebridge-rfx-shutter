...
export default class ShutterAccessory {
  ...
  public constructor(
    ...
    this.currentPosition = cache[`currentPosition_${this.serial}`] || DEFAULT_CURRENT_POSITION;
    //this.targetPosition = this.hap.Service.getItemSync(`targetPosition_${this.serial}`);
    this.targetPosition = cache[`targetPosition_${this.serial}`] || DEFAULT_TARGET_POSITION;
